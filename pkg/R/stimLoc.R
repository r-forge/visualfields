stimLoc <- function( perimetry, pattern, txtfont = "mono", pointsize = 7, xminmax = 29, yminmax = 29 ) {
  ...
  axis( 2, pos = 0, las = 1, lwd = 0.5, lwd.ticks = 0, at = c( -yminmax - 1, yminmax + 1 ), lab = c( yminmax + 1, yminmax + 1 ), hadj = -0.5, padj = c( 2, -1 ) )
