vfplotloc <- function( vals, patternMap, outerColor, innerColor = NULL, bs = NULL, axesCol = "black",
                       txtfont = "mono", pointsize = 7, xminmax = 29, yminmax = 29,
...
# Rectangles require matrix with 2 columns: 1st column specifies the width, 2nd column specifies the height
  ...
  text( patternMap$xod, patternMap$yod, labels = vals, adj = 0.525 )
